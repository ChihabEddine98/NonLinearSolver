...
#  May 10, 2020 07:26:20 AM CEST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top58 {base} {
    ...
    wm geometry $top 966x760+485+150
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    frame $site_3_0.fra62 \
        -relief groove -background #000 -height 77 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 637 
    ...
    place $site_4_0.lab63 \
        -in $site_4_0 -x 0 -relx 0.134 -y 0 -rely 0.213 -width 0 \
        -relwidth 0.647 -height 0 -relheight 1.064 -anchor nw \
        -bordermode ignore 
    frame $site_3_0.fra64 \
        -relief groove -background #000 -height 600 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 785 
    ...
    entry $site_4_0.ent45 \
        ...
        -insertbackground #00ff00 -insertborderwidth 1 -relief flat \
        -selectbackground #c4c4c4 -selectforeground black -width 334 
    vTcl:DefineAlias "$site_4_0.ent45" "entryErr" vTcl:WidgetProc "Toplevel1" 1
    ...
    entry $site_4_0.ent49 \
        ...
        -insertbackground #00ff00 -insertborderwidth 1 -relief flat \
        -selectbackground #c4c4c4 -selectforeground black -width 724 
    vTcl:DefineAlias "$site_4_0.ent49" "entryFomule_df" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_4_0.ent66 \
        -in $site_4_0 -x 0 -relx 0.038 -y 0 -rely 0.117 -width 724 \
        -relwidth 0 -height 54 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.but69 \
        -in $site_4_0 -x 0 -relx 0.566 -y 0 -rely 0.778 -width 276 \
        -relwidth 0 -height 53 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.lab73 \
        -in $site_4_0 -x 0 -relx 0.418 -y 0 -rely 0.017 -width 0 \
        -relwidth 0.125 -height 0 -relheight 0.082 -anchor nw \
        -bordermode ignore 
    place $site_4_0.ent44 \
        -in $site_4_0 -x 0 -relx 0.038 -y 0 -rely 0.556 -width 334 \
        -relwidth 0 -height 54 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.lab45 \
        -in $site_4_0 -x 0 -relx 0.151 -y 0 -rely 0.444 -width 0 \
        -relwidth 0.113 -height 0 -relheight 0.076 -anchor nw \
        -bordermode ignore 
    place $site_4_0.lab46 \
        -in $site_4_0 -x 0 -relx 0.692 -y 0 -rely 0.444 -width 0 \
        -relwidth 0.102 -height 0 -relheight 0.076 -anchor nw \
        -bordermode ignore 
    place $site_4_0.ent48 \
        -in $site_4_0 -x 0 -relx 0.541 -y 0 -rely 0.556 -width 334 \
        -relwidth 0 -height 54 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.ent45 \
        -in $site_4_0 -x 0 -relx 0.05 -y 0 -rely 0.778 -width 334 -relwidth 0 \
        -height 54 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.lab47 \
        -in $site_4_0 -x 0 -relx 0.013 -y 0 -rely 0.683 -width 0 \
        -relwidth 0.19 -height 0 -relheight 0.076 -anchor nw \
        -bordermode ignore 
    place $site_4_0.ent49 \
        -in $site_4_0 -x 0 -relx 0.038 -y 0 -rely 0.349 -width 724 \
        -relwidth 0 -height 54 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.lab50 \
        -in $site_4_0 -x 0 -relx 0.431 -y 0 -rely 0.233 -width 0 \
        -relwidth 0.113 -height 0 -relheight 0.065 -anchor nw \
        -bordermode ignore 
    ...
    place $site_3_0.fra62 \
        -in $site_3_0 -x 0 -relx 0.186 -y 0 -rely -0.026 -width 0 \
        -relwidth 0.659 -height 0 -relheight 0.101 -anchor nw \
        -bordermode ignore 
    place $site_3_0.fra64 \
        -in $site_3_0 -x 0 -relx 0.083 -y 0 -rely 0.079 -width 0 \
        -relwidth 0.817 -height 0 -relheight 0.789 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but70 \
        -in $site_3_0 -x 0 -relx 0.031 -y 0 -rely 0.908 -width 186 \
