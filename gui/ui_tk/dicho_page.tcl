...
#  Apr 19, 2020 06:17:45 PM CEST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top58 {base} {
    ...
    vTcl:withBusyCursor {
    frame $top.fra61 \
        -borderwidth 2 -relief groove -background #000 -height 725 -width 965 
    vTcl:DefineAlias "$top.fra61" "mainFrame" vTcl:WidgetProc "Toplevel1" 1
    set site_3_0 $top.fra61
    frame $site_3_0.fra62 \
        -relief groove -background #000 -height 104 -width 649 
    ...
    label $site_4_0.lab63 \
        ...
        -font {-family {Tw Cen MT} -size 23} -foreground #fff \
        -text {Méthode De dichotomie} 
    vTcl:DefineAlias "$site_4_0.lab63" "Label1" vTcl:WidgetProc "Toplevel1" 1
    place $site_4_0.lab63 \
        -in $site_4_0 -x 0 -relx 0.154 -y 0 -rely 0.192 -width 0 \
        -relwidth 0.682 -height 0 -relheight 0.625 -anchor nw \
        -bordermode ignore 
    frame $site_3_0.fra64 \
        -relief groove -background #000 -height 325 -width 743 
    ...
    entry $site_4_0.ent66 \
        ...
        -insertbackground black -relief groove -width 584 
    ...
    place $site_4_0.ent66 \
        -in $site_4_0 -x 0 -relx 0.162 -y 0 -rely 0.308 -width 584 \
        -relwidth 0 -height 54 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.lab67 \
        -in $site_4_0 -x 0 -relx 0.296 -y 0 -rely 0.123 -width 0 \
        -relwidth 0.405 -height 0 -relheight 0.151 -anchor nw \
        -bordermode ignore 
    place $site_4_0.but69 \
        -in $site_4_0 -x 0 -relx 0.276 -y 0 -rely 0.585 -width 276 \
        -relwidth 0 -height 53 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.lab73 \
        -in $site_4_0 -x 0 -relx -0.013 -y 0 -rely 0.277 -width 0 \
        -relwidth 0.163 -height 0 -relheight 0.151 -anchor nw \
        -bordermode ignore 
    ...
    place $site_3_0.fra62 \
        -in $site_3_0 -x 0 -relx 0.155 -y 0 -rely 0.124 -width 0 \
        -relwidth 0.673 -height 0 -relheight 0.143 -anchor nw \
        -bordermode ignore 
    place $site_3_0.fra64 \
        -in $site_3_0 -x 0 -relx 0.104 -y 0 -rely 0.316 -width 0 \
        -relwidth 0.769 -height 0 -relheight 0.446 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but70 \
        -in $site_3_0 -x 0 -relx 0.072 -y 0 -rely 0.838 -width 256 \
