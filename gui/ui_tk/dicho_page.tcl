...
#  Apr 21, 2020 11:09:10 PM CEST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top58 {base} {
    ...
    frame $site_3_0.fra64 \
        -relief groove -background #000 -height 314 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 793 
    ...
    button $site_4_0.but69 \
        ...
        -highlightthickness 2 -pady 0 -relief flat -text Solve 
    ...
    place $site_4_0.lab67 \
        -in $site_4_0 -x 0 -relx 0.34 -y 0 -rely 0.064 -width 0 \
        -relwidth 0.405 -height 0 -relheight 0.153 -anchor nw \
        -bordermode ignore 
    place $site_4_0.but69 \
        -in $site_4_0 -x 0 -relx 0.315 -y 0 -rely 0.637 -width 276 \
        -relwidth 0 -height 53 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.lab73 \
        -in $site_4_0 -x 0 -relx 0.076 -y 0 -rely 0.287 -width 0 \
    ...
    place $site_3_0.fra62 \
        -in $site_3_0 -x 0 -relx 0.166 -y 0 -rely 0.082 -width 0 \
        -relwidth 0.674 -height 0 -relheight 0.114 -anchor nw \
        -bordermode ignore 
    place $site_3_0.fra64 \
        -in $site_3_0 -x 0 -relx 0.093 -y 0 -rely 0.302 -width 0 \
        -relwidth 0.821 -height 0 -relheight 0.431 -anchor nw \
        -bordermode ignore 
